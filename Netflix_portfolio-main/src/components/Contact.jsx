        ...
        >
          ...
          <div className="flex items-center justify-between mb-12 md:mb-16">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded bg-red-600/10 border border-red-600/30 text-xs font-mono uppercase tracking-widest text-red-500">
              ...
              <span>EEPISODE 04 // ESTABLISH CONTACT</span>
            </div>
              ...
              <div className="flex-1 flex flex-col">
                <div className="relative h-full flex flex-col">
                  <textarea 
                    ...
                    onChange={handleChange}
                    placeholder="Describe your project, investigation, collaboration, or inquiry..."
                    required
            ...
            <div className="flex flex-col md:flex-row gap-12 mt-4 pt-6 border-t border-white/10">
              ...
              <div className="flex-1 flex items-start gap-4 text-sm font-light text-white/70">
                ...
                <label htmlFor="permission" className="cursor-pointer max-w-[280px] leading-snug">
                  I authorize contact regarding this inquiry.
                </label>
              </div>
              ...
              <div className="flex-1 flex flex-col gap-8 text-xs text-white/50 font-light">
                <p className="leading-relaxed max-w-[400px]">
                  Your inquiry will be reviewed and handled professionally. Please avoid including sensitive credentials or confidential evidence.
                </p>
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-6">
                  <p className="max-w-[250px] leading-relaxed">
                    Have a security project, forensic inquiry, research opportunity, or collaboration in mind? Let's start the conversation.
                  </p>
