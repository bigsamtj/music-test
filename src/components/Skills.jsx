...
const skillCategories = [
  { 
    ...
    desc: 'Analyzing and reconstructing digital evidence across computer, mobile, cloud, memory, and network environments while maintaining forensic integrity and investigative context.', 
    tag: 'FORENSIC TOOLKIT',
    skills: ['Autopsy', 'FTK Imager', 'Magnet AXIOM', 'Cellebrite', 'Oxygen', 'Volatility'] 
  },
  { 
    title: 'Cybercrime Investigation', 
    desc: 'Correlating digital artifacts, online intelligence, and behavioral indicators to reconstruct incidents, identify investigative leads, and develop evidence-based findings.', 
    tag: 'DIGITAL INTELLIGENCE',
    skills: ['OSINT', 'Cyber Intelligence', 'Artifact Analysis', 'Timeline Analysis', 'Evidence Correlation'] 
  },
  { 
    title: 'Ethical Hacking', 
    desc: 'Assessing systems and applications through reconnaissance, enumeration, vulnerability assessment, and controlled offensive security testing.', 
    tag: 'OFFENSIVE SECURITY',
    skills: ['Kali Linux', 'Nmap', 'Burp Suite', 'Metasploit', 'Web Security', 'API Security'] 
  },
  { 
    title: 'Security Research', 
    desc: 'Investigating emerging vulnerabilities, attack surfaces, threat techniques, and defensive strategies to understand how digital systems can be compromised and secured.', 
    tag: 'THREAT RESEARCH',
    skills: ['Threat Analysis', 'Vulnerability Research', 'Attack Surfaces', 'Security Testing', 'CTI'] 
  },
  { 
    title: 'AI / ML Security', 
    desc: 'Exploring security challenges across intelligent systems, including adversarial machine learning, model security, prompt injection, and AI-assisted cyber operations.', 
    tag: 'AI SECURITY',
    skills: ['Adversarial ML', 'Prompt Injection', 'Model Security', 'AI Attack Surfaces', 'AI Threat Detection'] 
  },
  { 
    title: 'Software Engineering', 
    desc: 'Exploring secure software development through frontend and backend engineering, application architecture, APIs, automation, and human-centered digital product design.', 
