      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full space-y-16">
        ...
        <div className="flex flex-col items-start space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded bg-black/80 backdrop-blur-2xl border border-red-600/40 text-xs font-mono uppercase tracking-widest text-white shadow-2xl">
            ...
            <span className="text-red-500 font-bold">CASE FILE 10</span>
            <span className="text-white/40">|</span>
            <span>ABOUT THE INVESTIGATOR</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              <h3 className="text-xs font-mono uppercase tracking-widest text-red-500 font-bold">IDENTITY & BACKGROUND</h3>
              <p className="text-lg md:text-xl font-medium text-white/90 leading-relaxed">
                I am <span className="text-white font-bold drop-shadow">Samuel Adeyinka</span>, a Digital Forensic Analyst and cybersecurity professional working across digital forensics, cybercrime investigation, security research, ethical hacking, AI/ML security, cyber intelligence, and secure technology development.
              </p>
              <p className="text-sm md:text-base text-white/60 font-light leading-relaxed">
                My work sits at the intersection of investigation, intelligence, security, and engineering. I approach technology not only as something to use, but as something to understand, investigate, secure, and improve , from reconstructing digital evidence and analyzing complex artifacts to exploring emerging security challenges and building technology-driven solutions.
              </p>
            </div>
            
            <div className="pt-8 flex flex-wrap gap-2 relative z-10">
              <span className="px-3.5 py-1.5 rounded bg-white/5 border border-white/10 text-xs font-mono text-white/80">Digital Forensics</span>
              <span className="px-3.5 py-1.5 rounded bg-white/5 border border-white/10 text-xs font-mono text-white/80">Ethical Hacker</span>
              <span className="px-3.5 py-1.5 rounded bg-white/5 border border-white/10 text-xs font-mono text-white/80">Security Researcher</span>
            </div>
          </div>
            ...
            <div className="space-y-5 relative z-10">
              ...
              <ul className="space-y-3.5 text-sm text-white/80 font-light">
                <li className="flex items-start gap-2.5">
                  ...
                  <span>Digital Forensic Analyst at<strong className="text-white">Proforce Intelligence Systems,</strong> conducting digital forensic examinations and generating actionable digital intelligence.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
                  <span>Author of The<strong className="text-white">Digital Forensics Playbook</strong> and actively involved in digital forensics education, cybersecurity research, and professional knowledge sharing.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
                  <span>Certified <strong className="text-white">Google Cybersecurity,Professional Ethical Hacking</strong> & <strong className="text-white">Cybercrime Investigation</strong>.</span>
                </li>
              </ul>
            </div>
          ...
          >
            ...
            <div className="space-y-2 text-left relative z-10">
              <h3 className="text-xs font-mono uppercase tracking-widest text-red-500 font-bold">Technical Arsenal</h3>
            ...
            <div className="flex flex-wrap items-center gap-3 relative z-10">
              {['Autopsy','FTK Imager','Magnet AXIOM','Cellebrite','Oxygen','Wireshark','MobilEdit','Burp Suite','Nmap','Kali Linux'].map((tech, idx) => (
                <span
                  key={idx}
